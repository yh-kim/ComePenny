...
public class MyinfoLikeFragment extends Fragment {
    ...
    public static Fragment newInstance() {
        Fragment fragment = new MyinfoLikeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.activity_myinfo_like_fragment, container, false);

        // frgment 폰트 설정
        SetFont.setGlobalFont(rootView.getContext(), rootView);

        lv_mylike = (ListView) rootView.findViewById(R.id.lv_mylike);
        // Adapter 생성 
    ...
    private void initializeListener() {
        lv_mylike.setOnItemClickListener(new AdapterView.OnItemClickListener() {
        ...
        lv_mylike.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
    ...
    class NetworkGetMylikeList extends AsyncTask<String, String, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 0) {
                Log.i("Network mylikeData", jObjects.toString());
