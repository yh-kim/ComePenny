...
public class BoothItem {
    private int boothImg;
    private String name;
    private int booth_id;
    private int likeNum;
    private int ideaNum;

    public int getBoothImg() {
        return boothImg;
    }

    public void setBoothImg(int boothImg) {
    ...
    public BoothItem(int boothImg, String name, int booth_id, int likeNum, int ideaNum) {
